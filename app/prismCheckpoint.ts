...
export default function PrismCheckpoint() {
  ...
  return (
    <OnchainKitProvider chain={chain}>
      <div style={{ maxWidth: 920, margin: "54px auto", fontFamily: "system-ui" }}>
        <h1>PrismCheckpoint — Built for Base</h1>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <button onClick={runCheckpoint} style={{ padding: "6px 12px" }}>
            Run Checkpoint
          </button>
